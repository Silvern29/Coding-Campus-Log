            ...
            for (int vert = 0; vert < 10; vert++) {
                ...
                if (matrix[horz][vert].getTrolleyOnField() != null) {
                    switch (matrix[horz][vert].getTrolleyOnField().getWeight()) {
                        case 0:
                            g.drawImage(t, x, y, size, size, this);
                            break;
                        case 1:
                            g.drawImage(t1, x, y, size, size, this);
                            break;
                        case 2:
                            g.drawImage(t2, x, y, size, size, this);
                            break;
                        case 3:
                            g.drawImage(t3, x, y, size, size, this);
                            break;
                        case 4:
                            g.drawImage(t4, x, y, size, size, this);
                            break;
                        default:
                            g.drawImage(t5, x, y, size, size, this);
                    }
                } else {
                    switch (matrix[horz][vert].totalWeight()) {
                        case 0:
                            break;
                        case 1:
                            g.drawImage(b1, x, y, size, size, this);
                            break;
                        case 2:
                            g.drawImage(b2, x, y, size, size, this);
                            break;
                        case 3:
                            g.drawImage(b3, x, y, size, size, this);
                            break;
                        case 4:
                            g.drawImage(b4, x, y, size, size, this);
                            break;
                        default:
                            g.drawImage(b5, x, y, size, size, this);
                    }
                }
                x += size;
            }
